...
restaurant1 = Restaurant(name="Duff Kitchen", user_id="1")
...
restaurant2 = Restaurant(name="Biryani Pot", user_id="2")
...
menuItem1 = MenuItem(name="Veg Biryani",
                     ...
                     price="$7.99", restaurant=restaurant2, user_id=2)
...
menuItem2 = MenuItem(name="Avakai Biryani",
                     ...
                     price="$25",  restaurant=restaurant2, user_id=2)
...
menuItem3 = MenuItem(name="Gongura Biryani",
                     ...
                     price="$15", restaurant=restaurant2, user_id=2)

session.add(menuItem3)
session.commit()

# Menu for Biryani Pot
restaurant3 = Restaurant(name="Veggie Burger", user_id="3")

session.add(restaurant2)
session.commit()


menuItem1 = MenuItem(name="Veggie",
                     description="Soja with vegetables.",
                     price="$7.99", restaurant=restaurant3, user_id=3)

session.add(menuItem1)
session.commit()

menuItem2 = MenuItem(name="Albacore Tuna Salad",
                     description="Rice with Salad",
                     price="$25",  restaurant=restaurant3, user_id=3)

session.add(menuItem2)
session.commit()

menuItem3 = MenuItem(name="Avocado Enchiladas",
                     description="Avocado with rice",
                     price="$10", restaurant=restaurant3, user_id=3)
